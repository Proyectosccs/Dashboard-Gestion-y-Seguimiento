(function () {
  ...
  const STATIC_ZONE_COORDS = {
    ...
    // Tercera tanda (2026-09-03), geocodificada vía Nominatim/OpenStreetMap
    // para el resto de zonas (incluyendo las de 1 sola entrega) que tenían
    // suficiente detalle en el texto para ubicarlas con confianza.
    'Vargas, venezuela': [10.5802547, -66.8603468],
    'Carretera tacoa - puerto maya, comunidad picure, puerto carayaca, parroquia carayaca, municipio vargas, estado vargas, 1167, venezuela': [10.5542547, -67.1831289],
    'Estado vargas, venezuela': [10.5802547, -66.8603468],
    'Altos de caoma, san rafael de los molinos, parroquia carayaca, municipio vargas, estado vargas, 1167, venezuela': [10.5144145, -67.1285871],
    'Yagrumal, parroquia carayaca, municipio vargas, estado vargas, 1167, venezuela': [10.4921583, -67.1166373],
    'Tequechongos, avenida saluzzo, santa monica, los rosales, caracas, parroquia san pedro, municipio libertador, distrito metropolitano de caracas, distrito capital, 1040, venezuela': [10.4728469, -66.8944484],
    'El trebol, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.5934753, -66.9777343],
    'Universidad nacional experimental maritima del caribe, avenida el ejercito, las colinas, parroquia catia la mar, municipio vargas, estado vargas, 1162, venezuela': [10.5996741, -67.0315809],
    'Playa caribe, los corales, la guaira, parroquia caraballeda, municipio vargas, estado vargas, 1165, venezuela': [10.6191508, -66.8506491],
    'Catia la mar, las angustias, la paez, parroquia catia la mar, municipio vargas, estado vargas, 1162, venezuela': [10.6017605, -67.0248811],
    'La paez, parroquia catia la mar, municipio vargas, estado vargas, 1162, venezuela': [10.6009322, -67.0250542],
    'Real de playa verde, ciudad chavez, playa grande, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.6128633, -67.0237457],
    'Canaima, parroquia carlos soublette, municipio vargas, estado vargas, venezuela': [10.5944288, -66.9730425],
    'La lucha, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.6025918, -67.0204603],
    'Las angustias, la paez, parroquia catia la mar, municipio vargas, estado vargas, 1162, venezuela': [10.6040386, -67.0246831],
    'Tacagua, las angustias, la paez, parroquia catia la mar, municipio vargas, estado vargas, 1162, venezuela': [10.6031685, -67.0254195],
    'Playa grande, parroquia bolivar, municipio bermudez, estado sucre, 0294, venezuela': [10.6544136, -63.2849139],
    'Feria de frutas verduras y horralizas, calle 9, la atlantida, parroquia catia la mar, municipio vargas, estado vargas, 1162, venezuela': [10.6045549, -67.0296065],
    'Ciudad chavez, playa grande, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.6067725, -67.0240547],
    'Farmatodo, avenida central de playa grande, ciudad chavez, playa grande, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.6077922, -67.0201788],
    'Ciudad chavez, la lucha, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.6067725, -67.0240547],
    'Guaracarumbo, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.5706415, -66.9926602],
    'Bicentenaria, urbanizacion jose maria vargas, pariata, parroquia carlos soublette, municipio vargas, estado vargas, venezuela': [10.6006784, -66.9641322],
    'Estadio cesar nieves, pasarela, las angustias, la paez, parroquia catia la mar, municipio vargas, estado vargas, 1162, venezuela': [10.6024582, -67.0232987],
    'Guaracarumbo, week-end, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.5930082, -67.0145973],
    'El respiro, parroquia catia la mar, municipio vargas, estado vargas, 1162, venezuela': [10.5973974, -67.0221055],
    'Principal de playa grande, ciudad chavez, playa grande, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.6044436, -67.0271172],
    'La veguita, week-end, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.5983503, -67.0178359],
    'Parada barrio aeropuerto, avenida la armada, brisas del aeropuerto, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.5945150, -67.0038251],
    'Summa, via alterna a playa grande, ciudad chavez, la lucha, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.6043242, -67.0269422],
    'Santa eduvigis sector 1': [10.5931043, -66.9995302],
    'La esperanza, terrazas de alto picure, parroquia catia la mar, municipio vargas, estado vargas, 1162, venezuela': [10.5669320, -67.0755115],
    'Caracas, ciudad caribia, parroquia carayaca, municipio vargas, distrito metropolitano de caracas, estado vargas, 1167, venezuela': [10.5342069, -67.0348406],
    'Caracas, monte alto, parroquia el junquito, municipio libertador, distrito metropolitano de caracas, distrito capital, 1000, venezuela': [10.4776357, -67.0186256],
    'Macuto, parroquia macuto, municipio vargas, estado vargas, 1164, venezuela': [10.6064747, -66.8922851],
    'Automac, urbanizacion caribe, caraballeda, parroquia caraballeda, municipio vargas, estado vargas, 1165, venezuela': [10.6156531, -66.8436901],
    'La aviacion, el trebol, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.5958258, -66.9837760],
    'Los olivos, parroquia catia la mar, municipio vargas, estado vargas, 1162, venezuela': [10.5852697, -67.0189277],
    'Hospital san jose, calle real de maiquetia, casco central de maiquetia, el rincon, maiquetia, parroquia maiquetia, municipio vargas, estado vargas, 1161, venezuela': [10.5959777, -66.9571453],
    'Grupo medico catia la mar, calle 11, las angustias, la atlantida, catia la mar, parroquia catia la mar, municipio vargas, estado vargas, 1162, venezuela': [10.6029095, -67.0295286],
    'La roraima, parroquia catia la mar, municipio vargas, estado vargas, 1162, venezuela': [10.5900752, -67.0382781],
    'Catia la mar': [10.5992669, -67.0145106],
    'Oripia, los cujies, parroquia tacata, municipio guaicaipuro, estado miranda, 1211, venezuela': [10.2390165, -67.0241332],
    'Aeropuerto catia la mar': [10.5927141, -67.0043153],
    'Guaremal, parroquia guaremal, municipio guaicaipuro, estado miranda, 1201, venezuela': [10.2985077, -67.0327890],
    'Paso morocho, parroquia san casimiro, municipio san casimiro, estado aragua, venezuela': [9.9824710, -67.0249486],
    'Carretera vieja caracas - la guaira, pedro garcia, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.5720764, -66.9838396],
    'Ezequiel zamora, parroquia catia la mar, municipio vargas, estado vargas, 1162, venezuela': [10.5827175, -67.0174042],
    'Palo negro, municipio libertador, distrito metropolitano de caracas, distrito capital, venezuela': [10.4185988, -67.0473504],
    'E, avenida aeropuerto auxiliar, sotavento i, santa eduvigis, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.5983608, -66.9903427],
    'Carlos soublette, 10 de marzo, urbanizacion jose maria vargas, pariata, parroquia carlos soublette, municipio vargas, estado vargas, venezuela': [10.5993755, -66.9714264],
    'Hotel circulo militar de caracas, paseo los proceres, caracas, barrio las malvinas, san antonio, el valle, parroquia el valle, municipio libertador, distrito metropolitano de caracas, distrito capital, 1040, venezuela': [10.4689408, -66.8979642],
    'Playa los cocos, urbanizacion caribe, la guaira, parroquia caraballeda, municipio vargas, estado vargas, 1165, venezuela': [10.6159366, -66.8367350],
    'Autopista caracas - la guaira, caracas, parroquia sucre, municipio libertador, distrito metropolitano de caracas, distrito capital, 1010, venezuela': [10.5216390, -66.9452551],
    'Caracas, parroquia el junquito, municipio libertador, distrito metropolitano de caracas, distrito capital, venezuela': [10.4776357, -67.0186256],
    'Carretera paracotos - tacata, piedras azules, parroquia tacata, municipio guaicaipuro, estado miranda, 1211, venezuela': [10.2147445, -67.0086979],
    'Los corales, caraballeda, parroquia caraballeda, municipio vargas, estado vargas, 1165, venezuela': [10.6135241, -66.8565287],
    'Tunel boqueron i, salto boqueron, catia la mar, parroquia urimare, municipio vargas, distrito metropolitano de caracas, estado vargas, 1162, venezuela': [10.5657514, -67.0050967],
    'Rio arriba, parroquia tacata, municipio guaicaipuro, estado miranda, 1211, venezuela': [10.1546154, -67.0206249],
    'Oppe 25, avenida principal de caribe, tanaguarena, caraballeda, parroquia caraballeda, municipio vargas, estado vargas, 1165, venezuela': [10.6117357, -66.8298639],
    'Las tunitas, terrazas de alto picure, parroquia catia la mar, municipio vargas, estado vargas, 1162, venezuela': [10.5886936, -67.0636949],
    'Hospital dermatologico martin vegas, avenida fundacion mendoza, urbanizacion martin vegas, week-end, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.5880980, -67.0163952],
    'Carretera san casimiro - guiripa, el horno, parroquia guiripa, municipio san casimiro, estado aragua, venezuela': [10.0201726, -67.0157383],
    'La armada, la veguita, week-end, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.5992519, -67.0154353],
    'Fundacion mendoza, urbanizacion martin vegas, week-end, catia la mar, parroquia urimare, municipio vargas, estado vargas, 1162, venezuela': [10.5880585, -67.0174097]
  };
