-- Ajustes al formulario de eventos: agrega "Participantes" (roster
-- compartido de equipo + contactos de Coalición), quita "Descripción"
-- (esa información ahora va en Notas y Requerimientos) y unifica "Lugar" +
-- "Dirección" en un solo campo de Ubicación (ya usa la columna existente
-- "location"), así que la columna "venue" deja de usarse.
...
grant select (participants) on public.coalicion_events to anon, authenticated;
